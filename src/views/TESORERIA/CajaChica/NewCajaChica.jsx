...
export default function NewCajaChica({ isOpen, onClose }) {
        ...
        <div className="fixed inset-0 flex items-center justify-center px-4 z-50">
            ...
            <div className="relative bg-white p-7 rounded-2xl w-full max-w-4xl text-sm shadow-lg z-10 overflow-y-auto max-h-[90vh]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mt-4">
                    ...
                    <div className="flex flex-col">
                        <label className="text-sm text-gray-700">Hora <span className="text-red-500">(*)</span></label>
                        <input type="time" className="border border-gray-300 rounded-md p-2" />
                    </div>
                    <div className="flex flex-col">
                        <label className="text-sm text-gray-700">Fecha Valuta <span className="text-red-500">(*)</span></label>
                        <input type="date" className="border border-gray-300 rounded-md p-2" />
                    </div>
                    <div className="flex flex-col">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                    ...
                    <div className="flex flex-col">
                        <label className="text-sm text-gray-700">Número <span className="text-red-500">(*)</span></label>
                        <input type="text" className="border border-gray-300 rounded-md p-2" />
                    </div>
                    <div className="flex flex-col">
                        <label className="text-sm text-gray-700">Autoriza <span className="text-red-500">(*)</span></label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div className="flex flex-col">
                        <label className="text-sm text-gray-700">Motivo <span className="text-red-500">(*)</span></label>
                        <select className="border border-gray-300 rounded-md p-2">
                            <option>Seleccione</option>
                        </select>
                    </div>
                    <div className="flex flex-col">
                        <label className="text-sm text-gray-700">Submotivo <span className="text-red-500">(*)</span></label>
                        <select className="border border-gray-300 rounded-md p-2">
                            <option>Seleccione</option>
                        </select>
                    </div>
                ...
                <div className="mt-4">
                    <label className="text-sm text-gray-700">Descripción <span className="text-red-500">(*)</span></label>
